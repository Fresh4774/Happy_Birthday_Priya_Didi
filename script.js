$('.start').click(function(){
    $('.stage1').fadeOut();
    fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/cake_modal.png','To, Priya Didi','Since its your birthday! I find this fitting that you get to make your own digital birthday cake, Have a Nice Day Enjoy Happy Birthday :)');
})
...
$('.mixer').click(function(){
    ...
    if(mixtimes == 6){
        $('.stage2').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/mix_modal.png','Done!','Well the mixture is perfect! Its now time to put it in our digital oven for about 3 seconds ? That should be enough time for a nice spongy base :)');
...
$( ".oven" ).droppable({
    drop: function( event, ui ) {
        $('.stage3').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/oven_modal.png','Done!','I think You have become a master chef! The base is fully baked and looks super yummy. Now its time to combine this base with lots of other ingredients like jam chocolate and more :)');
    }
})
